...
class HybridOptim(torch.optim.Optimizer):
    ...
    def state_dict(
        self,
    ) -> List[Dict[str, Union[torch.Tensor, List[Dict[str, Union[torch.Tensor, float, bool, Any]]]]]]:
        """
    ...
    def load_state_dict(
        self,
        state_dict: List[Dict[str, Union[torch.Tensor, List[Dict[str, Union[torch.Tensor, float, bool, Any]]]]]],
    ) -> None:
        """
